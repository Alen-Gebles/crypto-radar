...
function Sidebar({ onCoinClick }) {
  ...
  return (
    <>
      ...
      <aside id='sideNav' className="h-screen border_left overflow-y-scroll absolute side_width bg_clr right-0 translate-x-full lg:translate-x-0 lg:relative lg:flexOne transition_main">
