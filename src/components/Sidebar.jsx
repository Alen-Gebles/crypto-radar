...
function Sidebar() {
  ...
  return (
    <>
      ...
      <aside id='sideNav' className="h-screen border_left overflow-y-scroll absolute side_width right-0 translate-x-full lg:translate-x-0 lg:relative lg:flexOne transition_main">
        ...
        {data && (
          <div className='w-full h-auto flex flex-col gap-2 mx-auto mt-4'>
            {data.map(coin => (
              <div key={coin.id} className='flex items-center text-white w-11/12 mx-auto p-3 bg-transparent transition cursor-pointer rounded-lg hover:bg-slate-800'>
